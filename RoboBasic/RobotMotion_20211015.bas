...
KEY55: ''문열고 탈출(오른쪽)
    ...
    GOSUB 자이로ON
	GOSUB 오른쪽옆으로걷기
	GOSUB 오른쪽옆으로걷기''한발자국 추가
    MOVE G6C,130,  90, 10 , , , ,
    MOVE G6B,190, 100 ,  , , , ,	
    WAIT
    GOSUB 오른쪽옆으로걷기
    DELAY 400 ''기존 코드 : DELAY X
    GOSUB 오른쪽옆으로걷기
    DELAY 400
    GOSUB 오른쪽옆으로걷기
    DELAY 400
    ...
    GOSUB 문오른쪽턴45
    DELAY 500'' 기존코드 : DELAY 200
    GOSUB 문오른쪽턴45
    DELAY 500
    GOSUB 문오른쪽턴45
    DELAY 500
    GOSUB 오른쪽턴20 ''1번 더 추가
    DELAY 500
    GOSUB 오른쪽턴20 ''1번 더 추가
    DELAY 500
    GOSUB 오른쪽턴20 ''1번 더 추가
